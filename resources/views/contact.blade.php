...
@section('main')
    ...
    <form action="/contact-us" method="post" novalidate>
        ...
        <div class="form-group">
            <label class="mr-sm-2" for="contact">Contact</label>
            <select class="custom-select mr-sm-2 form-control {{ $errors->first('contact') ? 'is-invalid' : '' }}"
                    required id="contact" type="contact" name="contact">
